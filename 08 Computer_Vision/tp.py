...
def train_all_models_from_images_incremental(
    ...
    print("=== 완료 ===")
    return final_models, best_model


best_model=train_all_models_from_images_incremental('../team_project/labeled_train.csv','../team_project/test.csv')
